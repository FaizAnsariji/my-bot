...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `👉 मेरा हैंडसम बॉस 😎   💋फैज अंसारी💋\n\n${c}, मुझे लोल बोला जाओ अब मैं तुमसे बात नही करूंगा 🥺 मैं नाराज हु अब तुमसे 😭 जा रहा हूं अपने बॉस फैज अंसारी को बताने की यू ने मुझे लोल बोला 😭😭😭👈`
	};
	...
	["Choru biot", "Choru bakla", "choru bakla", "Choru biot", "admin bayot", "Admin bayot", "Rhaine bobo", "stupid bots", "chicken bot", "bots lol", "stupid bots lol", "dog bot", "dm bot", "fuck bots", "dmm bot", "dam bot", "bobo Ginoong choru bot", "đb bot", "crazy bots", "bobo bot", "bot dở", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot cau"].forEach((a => {
		...
		if (b === a.toUpperCase() | b === a | d === b) {
			...
			n.setData(s, {
				...
				var n = o;
				for (var n of o) t.sendMessage(`=== फैज अंसारी सुनो ===\n\n😒 नाम 👉 ${c}\n😥 Uid 👉 ${s}\n😢 इसने बोला 👉 ${a}\n\nबॉस अब मैं इसे बात नही करूंगा 😭👈`, n)
			}))
		}
	}))
