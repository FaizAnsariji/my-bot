...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("MIRAI PROJECT", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("saikidesu.dev", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("mraikero-01", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("tzudaki_", 2000, 3600);
    ctx.beginPath();
